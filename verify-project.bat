...
mvn -q clean & mvn -q compile & mvn -q package & java -cp target\jdk.primitives-1.0-SNAPSHOT.jar prim.Main & mvn test -Dtest=MainTest
...
:: Below are test values for my javafx calculator program
@REM 25/169
@REM 0.555E-3
@REM 1024/255
@REM 5-6
