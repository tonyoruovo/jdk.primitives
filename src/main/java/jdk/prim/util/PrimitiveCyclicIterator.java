 ...
 * {@link PrimitiveCyclicIterator} instances must have at least one element, or their
 ...
 * PrimitiveCyclicIterator&lt;Integer&gt; cyclicIterator = PrimitiveIterators.c(numbers);
 * 
 ...
 * PrimitiveCyclicIterator&lt;String&gt; cyclicIterator = PrimitiveIterators.c(colors);
 * 
 * for (int i = 0; i &lt; 5; i++) {
 *     System.out.println(cyclicIterator.next());
 * }
 ...
 */
public interface PrimitiveCyclicIterator<T> extends Iterator<T> {
	 ...
	 * {@code PrimitiveCyclicIterator} and extends {@code PrimitiveIterator.OfDouble} to
	 ...
	 * PrimitiveCyclicIterator.OfDouble cyclicIterator = PrimitiveIterators.c(sineWave);
	 * 
	 ...
	 *           {@link #remove()}
	 */
	interface OfDouble extends java.util.PrimitiveIterator.OfDouble, PrimitiveCyclicIterator<Double> {
	}

	/**
	 * Interface for iterating over primitive {@code long} values in a cyclic
	 * manner. This interface is a purely primitive extension of
	 * {@code PrimitiveCyclicIterator} and extends {@code PrimitiveIterator.OfLong} to
	 * provide cyclic iteration capabilities specifically for {@code long} values.
	 * 
	 * <p>
	 * Practical usage example of {@code PrimitiveCyclicIterator.OfLong} in cryptography and
	 ...
	 * PrimitiveCyclicIterator.OfLong cyclicIterator = PrimitiveIterators.c(circularBuffer);
	 * 
	 ...
	 * 
	 * <p>
	 * This practical usage demonstrates how {@code PrimitiveCyclicIterator.OfLong} can be
	 ...
	 *           {@link #remove()}
	 */
	interface OfLong extends java.util.PrimitiveIterator.OfLong, PrimitiveCyclicIterator<Long> {
	}

	/**
	 * Interface for iterating over primitive {@code int} values in a cyclic manner.
	 * This interface is a purely primitive extension of {@code PrimitiveCyclicIterator} and
	 * extends {@code PrimitiveIterator.OfInt} to provide cyclic iteration
	 * capabilities specifically for {@code int} values.
	 * 
	 * <p>
	 * Practical usage example of {@code PrimitiveCyclicIterator.OfInt} in digital signal
	 ...
	 * 
	 * // Create a cyclic iterator for the circular buffer
	 * PrimitiveCyclicIterator.OfInt cyclicIterator = PrimitiveIterators.c(circularBuffer);
	 * 
	 ...
	 * 
	 * <p>
	 * This practical usage demonstrates how {@code PrimitiveCyclicIterator.OfInt} can be
	 ...
	 *           {@link #remove()}
	 */
	interface OfInt extends java.util.PrimitiveIterator.OfInt, PrimitiveCyclicIterator<Integer> {
	}

	/**
	 * Interface for iterating over primitive {@code char} values in a cyclic
	 * manner. This interface is a purely primitive extension of
	 * {@code PrimitiveCyclicIterator} and extends {@code PrimitiveIterator.OfChar} to
	 ...
	 * <code>
	 * char[] symbols = {'*', '+', '-'};
	 * PrimitiveCyclicIterator.OfChar cyclicIterator = PrimitiveIterators.c(symbols);
	 * 
	 * for (int i = 0; i < 5; i++) {
	 ...
	 *           {@link #remove()}
	 */
	interface OfChar extends PrimitiveIterator.OfChar, PrimitiveCyclicIterator<Character> {
	}

	/**
	 * Interface for iterating over primitive {@code float} values in a cyclic
	 * manner. This interface is a purely primitive extension of
	 * {@code PrimitiveCyclicIterator} and extends {@code PrimitiveIterators.OfFloat} to provide
	 * cyclic iteration capabilities specifically for {@code float} values.
	 * <p>
	 * Practical usage example of {@code PrimitiveCyclicIterator.OfFloat} in gaming/data
	 ...
	 * PrimitiveCyclicIterator.OfFloat cyclicX = createCircularIterator(centerX, radius, 0.0f, 2 * Math.PI, angularVelocity);
	 * PrimitiveCyclicIterator.OfFloat cyclicY = createCircularIterator(centerY, radius, 0.0f, 2 * Math.PI, angularVelocity);
	 * 
	 ...
	 * 
	 * <p>
	 * This practical usage demonstrates how {@code PrimitiveCyclicIterator.OfFloat} can be
	 ...
	 *           {@link #remove()}
	 */
	interface OfFloat extends PrimitiveIterator.OfFloat, PrimitiveCyclicIterator<Float> {
	}

	/**
	 * Interface for iterating over primitive {@code short} values in a cyclic
	 * manner. This interface is a purely primitive extension of
	 * {@code PrimitiveCyclicIterator} and extends {@code PrimitiveIterator.OfShort} to
	 * provide cyclic iteration capabilities specifically for {@code short} values.
	 * 
	 * <p>
	 * Practical usage example of {@code PrimitiveCyclicIterator.OfShort} in a Unicode
	 ...
	 * 
	 * // Create a cyclic iterator for the circular buffer
	 * PrimitiveCyclicIterator.OfShort cyclicIterator = PrimitiveIterators.c(circularBuffer);
	 * 
	 ...
	 * 
	 * <p>
	 * This practical usage demonstrates how {@code PrimitiveCyclicIterator.OfShort} can be
	 ...
	 *           {@link #remove()}
	 */
	interface OfShort extends PrimitiveIterator.OfShort, PrimitiveCyclicIterator<Short> {
	}

	/**
	 * Interface for iterating over primitive {@code byte} values in a cyclic
	 * manner. This interface is a purely primitive extension of
	 * {@code PrimitiveCyclicIterator} and extends {@code PrimitiveIterators.OfByte} to provide cyclic
	 * iteration capabilities specifically for {@code byte} values.
	 * 
	 * <p>
	 * Practical usage example of {@code PrimitiveCyclicIterator.OfByte} in any programming
	 ...
	 * 
	 * // Create a cyclic iterator for the circular buffer
	 * PrimitiveCyclicIterator.OfByte cyclicIterator = PrimitiveIterators.c(circularBuffer);
	 * 
	 ...
	 * 
	 * <p>
	 * This practical usage demonstrates how {@code PrimitiveCyclicIterator.OfByte} can be
	 ...
	 *           {@link #remove()}
	 */
	interface OfByte extends PrimitiveIterator.OfByte, PrimitiveCyclicIterator<Byte> {
	}

	/**
	 * Interface for iterating over primitive {@code boolean} values in a cyclic
	 * manner. This interface is a purely primitive extension of
	 * {@code PrimitiveCyclicIterator} and extends {@code PrimitiveIterator.OfBoolean} to
	 ...
	 * PrimitiveCyclicIterator.OfBoolean cyclicIterator = PrimitiveIterators.c(flags);
	 * 
	 ...
	 *           {@link #remove()}
	 */
	interface OfBoolean extends PrimitiveIterator.OfBoolean, PrimitiveCyclicIterator<Boolean> {
	}
